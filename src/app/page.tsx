      ...
      <div className="z-10  flex flex-col absolute w-full justify-center items-center pointer-events-none">
        ...
        <div className="bg-white backdrop-blur-md   text-white p-5  w-full max-w-[1000px] " id="qsomo">
          ...
          <p className="text-black ">
            ...
            <div className="bg-black/30 gap-5 flex flex-col sticky my-24 justify-center items-center text-white p-5  w-auto max-w-[1000px]" >
            
                <div className="flex gap-3 w-full">
                  <Image src={"/h01.jpg"} width={150} height={1} alt="h1" className="shadow-2xl shadow-yellow-400 rounded-2xl"/>
                  <Image src={"/h04.jpg"} width={150} height={1} alt="h4" className="shadow-2xl shadow-yellow-400 rounded-2xl"/>
                </div>         
                <Image src={"/h03.jpg"} width={300} height={1} alt="h3" className="shadow-2xl shadow-yellow-400 rounded-2xl"/>
                <div className="flex gap-3">
                  <Image src={"/pr01.jpg"} width={150} height={1} alt="h5" className="shadow-2xl shadow-yellow-400 rounded-2xl"/>
                  <Image src={"/h05.jpg"} width={150} height={1} alt="h5" className="shadow-2xl shadow-yellow-400 rounded-2xl"/>
                </div>

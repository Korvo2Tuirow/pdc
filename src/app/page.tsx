  ...
  return (
    <div>
      ...
      <div className="z-10 flex p-10 gap-24 flex-col absolute w-full justify-center items-center pointer-events-none ">
        ...
        <div className="bg-white/30 backdrop-blur-md border-2 text-lg border-yellow-400 text-white p-5 rounded-lg w-full max-w-[1000px] shadow-2xl shadow-yellow-400">

          <h1 className=" text-4xl text-white flex justify-center items-center mb-5 text-center">🍔🔥 Bem-vindo ao Point do Canal – O Sabor que Conquista!</h1>
